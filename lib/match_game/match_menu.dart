...
import 'package:flutter_application_0/match_game/gamelevel.dart';
import 'package:flutter_application_0/match_game/match_page/howtoplay_matchgame.dart';
...
void _navigateToPage(String buttonType) async {
  switch (buttonType) {
    case 'เล่น':
      ...
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => const HowToPlay_Matchgame()),
      );
      case 'ออก':
      Navigator.push(
        context,
